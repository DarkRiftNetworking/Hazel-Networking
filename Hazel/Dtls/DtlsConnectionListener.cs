...
namespace Hazel.Dtls
{
    ...
    public class DtlsConnectionListener : ThreadLimitedUdpConnectionListener
    {
        ...
        ///
        /// This first certificate must be the identifying certificate for the
        /// listener. Subsequent certificates must sign the immediately preceeding
        /// certificate
        /// </summary>
        /// <param name="certificate">Certificate for the server</param>
        public void SetCertificates(X509Certificate2 certificate)
        {
